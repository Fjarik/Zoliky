...
namespace ZolikyUWP
{
	sealed partial class App : Application
	{
		...
		private async Task InitNotificationsAsync()
		{
			...
			var hubname = "ZolikyUwp";
			var listen =
				"Endpoint=sb://zoliky.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=hHcom2TsUPMysnAIFHL3g9kya7mgMsDcMfBjBP+QLa4=";
